...
def main():
    ...
    default_users = [
        {"username": "admin", "password": "root", "role": "gerente", "full_name": "Administrador"},
        {"username": "user_caixa", "password": "123", "role": "caixa", "full_name": "Caixa 1"},
        {"username": "estoque1", "password": "123", "role": "estoque", "full_name": "Auxiliar de Estoque"},
    ]
    ...
    print("\nLogin padrão:")
    print("- Gerente: usuário 'admin' | senha 'root'")
    print("- Caixa:   usuário 'user_caixa' | senha '123'")
    print("- Estoque: usuário 'estoque1'   | senha '123'")
